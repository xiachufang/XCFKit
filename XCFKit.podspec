Pod::Spec.new do |s|
  ...
  s.source_files     = "XCFKit"
  s.resource_bundles =  {'XCFKitResources' => ['XCFKit/UI/buttonBackgroundImages.xcassets/*.imageset/*.png','XCFKit/UI/buttonBackgroundImages.xcassets']}
